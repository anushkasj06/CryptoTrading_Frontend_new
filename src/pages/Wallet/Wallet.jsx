...
const paymentStatus = query.get("razorpay_payment_link_status");
const razorpaySignature = query.get("razorpay_signature");
...
}, [orderId, order_id, razorpayPaymentId, paymentStatus]);
